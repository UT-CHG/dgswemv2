...
int main() {
    ...
    Utilities::LinearAlgebra::Vector<double, 2> vec;
    Utilities::LinearAlgebra::Vector<double, 2> vec_res;
    ...
    Utilities::LinearAlgebra::Matrix<double, 2, 2> outer_product;
    ...
    Utilities::LinearAlgebra::Matrix<double, 2, 2> mat;
    Utilities::LinearAlgebra::Matrix<double, 2, 2> mat_res;
    ...
    Utilities::LinearAlgebra::Matrix<double, 1, 2> mat_out;
