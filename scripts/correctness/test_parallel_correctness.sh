...
make partitioner
make RKDG_MANUFACTURED_SOLUTION_SERIAL
make RKDG_MANUFACTURED_SOLUTION_HPX
make RKDG_MANUFACTURED_SOLUTION_OMPI
echo ""
...
rm -f serial.out
$DGSWEMV2_ROOT_/build/examples/rkdg_swe_manufactured_solution/RKDG_MANUFACTURED_SOLUTION_SERIAL dgswemv2_input.15 &> serial.out
...
OMP_NUM_THREADS=1 mpirun -np 2 ${CI_MPI_CLI} $DGSWEMV2_ROOT_/build/examples/rkdg_swe_manufactured_solution/RKDG_MANUFACTURED_SOLUTION_OMPI dgswemv2_input_parallelized.15 &> ompi.out
