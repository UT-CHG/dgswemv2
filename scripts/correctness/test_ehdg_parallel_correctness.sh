...
make partitioner
make EHDG_MANUFACTURED_SOLUTION_SERIAL
make EHDG_MANUFACTURED_SOLUTION_HPX
make EHDG_MANUFACTURED_SOLUTION_OMPI
echo ""
echo "Setting up runtime files..."
cd $HOME
mkdir -p dgswemv2_test
cp -r $DGSWEMV2_ROOT_/examples/ehdg_swe_manufactured_solution/input_files/* dgswemv2_test
...
rm -f serial.out
$DGSWEMV2_ROOT_/build/examples/ehdg_swe_manufactured_solution/EHDG_MANUFACTURED_SOLUTION_SERIAL dgswemv2_input.15 &> serial.out

echo "Running HPX Test case..."
rm -f hpx.out
$DGSWEMV2_ROOT_/build/partitioner/partitioner dgswemv2_input.15 2 1
$DGSWEMV2_ROOT_/build/examples/ehdg_swe_manufactured_solution/EHDG_MANUFACTURED_SOLUTION_HPX dgswemv2_input_parallelized.15 --hpx:threads=2 &> hpx.out
...
OMP_NUM_THREADS=1 mpirun -np 2 ${CI_MPI_CLI} $DGSWEMV2_ROOT_/build/examples/ehdg_swe_manufactured_solution/EHDG_MANUFACTURED_SOLUTION_OMPI dgswemv2_input_parallelized.15 &> ompi.out
