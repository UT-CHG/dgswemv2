...
template<class Master>
void ELEMENT<Master>::InitializeVTKTriangle(std::vector<Point<3>>& points, Array2D<unsigned int>& cells) {
...
template<class Master>
void ELEMENT<Master>::WriteCellDataVTKTriangle(std::vector<double>& cell_data, int u_flag) {
...
template<class Master>
void ELEMENT<Master>::WritePointDataVTKTriangle(std::vector<double>& point_data, int u_flag) {
