...
namespace Shape {
	...
	std::vector<double> StraightTriangle::get_surface_J_(int n_bound, const std::vector<Point<2>>& nodal_coordinates) {
	...
	Array3D<double> StraightTriangle::get_surface_normal(const std::vector<Point<2>>& nodal_coordinates) {
		...
		surface_normal[0].resize(2);
		surface_normal[1].resize(2);
		surface_normal[2].resize(2);
	...
	Array2D<double> StraightTriangle::get_surface_normal_(int n_bound, const std::vector<Point<2>>& nodal_coordinates) {
