...
Stepper::Stepper(uint nstages, uint order, double dt)
    ...
    if ((this->nstages == 1) && (order == 1)) {
        this->ark[0][0] = 1.;
        this->brk[0][0] = 1.;

        // SSP(s,2) schemes
    } else if ((this->nstages == 2) && (order == 2)) {
        this->ark[0][0] = 1;
        this->ark[1][0] = 0.5;
        this->ark[1][1] = 0.5;
        ...
        // SSP(3,3) scheme
    } else if ((this->nstages == 3) && (order == 3)) {
        this->ark[0][0] = 1.;
        this->ark[1][0] = 3. / 4.;
        this->ark[1][1] = 1. / 4.;
        this->ark[2][0] = 1. / 3.;
        ...
        // SP(4,3) scheme
    } else if ((this->nstages == 4) && (order == 3)) {
        this->ark[0][0] = 1.;
        this->ark[1][1] = 1.;
        this->ark[2][0] = 2. / 3.;
        this->ark[2][2] = 1. / 3.;
        ...
        // SSP(5,3) scheme
    } else if ((this->nstages == 5) && (order == 3)) {
        this->ark[0][0] = 1.;
        this->ark[1][1] = 1.;
        ...
        // SSP(6,3) scheme
    } else if ((this->nstages == 6) && (order == 3)) {
        this->ark[0][0] = 1.;
        this->ark[1][1] = 1.;
        this->ark[2][2] = 1.;
        ...
        // SSP(7,3) scheme
    } else if ((this->nstages == 7) && (order == 3)) {
        this->ark[0][0] = 1.;
        this->ark[1][1] = 1.;
        this->ark[2][2] = 1.;
        ...
        // SSP(8,3) scheme
    } else if ((this->nstages == 8) && (order == 3)) {
        this->ark[0][0] = 1.;
        this->ark[1][1] = 1.;
        this->ark[2][2] = 1.;
        this->ark[3][3] = 1.;
        ...
        // SSP(5,4) scheme
    } else if ((this->nstages == 5) && (order == 4)) {
        this->ark[0][0] = 1.;
        ...
        // SSP(6,4) scheme
    } else if ((this->nstages == 6) && (order == 4)) {
        ...
        // SSP(7,4) scheme
    } else if ((this->nstages == 7) && (order == 4)) {
        this->ark[0][0] = 1.;
        ...
        // SSP(8,4) scheme
    } else if ((this->nstages == 8) && (order == 4)) {
        this->ark[0][0] = 1.;
