...
class CUDASimulationUnit : public Simulation<ProblemType> {
  public:
    CUDASimulationUnit() : Simulation<ProblemType>() {}
    CUDASimulationUnit(std::string& input_string) : Simulation<ProblemType>(input_string) {}
    void Run();
};

template <typename ProblemType>
void CUDASimulationUnit<ProblemType>::Run() {
