#ifndef IHDG_SIMULATION_HPX_HPP
#define IHDG_SIMULATION_HPX_HPP
...
#define IHDG_REGISTER_HPX_COMPONENTS(ProblemType)                                                              \
    using hpx_simulation_unit_ = IHDG::HPXSimulationUnit<ProblemType>;                                         \
    using hpx_simulation_unit_swe_component_ =                                                                 \
        hpx::components::simple_component<IHDG::HPXSimulationUnit<ProblemType>>;                               \
    HPX_REGISTER_COMPONENT(hpx_simulation_unit_swe_component_, hpx_simulation_unit_swe_);                      \
                                                                                                               \
    using hpx_simulation_swe_           = IHDG::HPXSimulation<ProblemType>;                                    \
    using hpx_simulation_swe_component_ = hpx::components::simple_component<IHDG::HPXSimulation<ProblemType>>; \
