#ifndef EHDG_SWE_LLF_FLUX_HPP
#define EHDG_SWE_LLF_FLUX_HPP
...
inline void LLF_flux(const double gravity,
    ...
    double ze_flux_x_in = qx_in;
    double ze_flux_y_in = qy_in;

    double qx_flux_x_in = (uuh_in + pe_in);
    double qx_flux_y_in = uvh_in;

    double qy_flux_x_in = uvh_in;
    ...
    double ze_flux_x_ex = qx_ex;
    double ze_flux_y_ex = qy_ex;

    double qx_flux_x_ex = (uuh_ex + pe_ex);
    double qx_flux_y_ex = uvh_ex;

    double qy_flux_x_ex = uvh_ex;
