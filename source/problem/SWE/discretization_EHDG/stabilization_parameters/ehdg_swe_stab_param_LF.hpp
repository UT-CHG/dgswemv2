...
inline void add_kernel_tau_terms_intface_LF(EdgeInterfaceType& edge_int) {
    ...
    for (uint gp = 0; gp < edge_int.edge_data.get_ngp(); ++gp) {
        ...
        u_hat = edge_internal.q_hat_at_gp[gp][SWE::Variables::qx] / edge_internal.h_hat_at_gp[gp];
        v_hat = edge_internal.q_hat_at_gp[gp][SWE::Variables::qy] / edge_internal.h_hat_at_gp[gp];
        ...
        Vector<double, SWE::n_variables> del_u =
            boundary_in.q_at_gp[gp] + boundary_ex.q_at_gp[gp_ex] - 2.0 * edge_internal.q_hat_at_gp[gp];
