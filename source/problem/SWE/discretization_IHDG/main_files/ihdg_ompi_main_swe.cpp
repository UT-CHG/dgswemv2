...
#include "simulation/simulation_IHDG/ompi/ihdg_simulation_ompi.hpp"
#include "simulation/stepper/rk_stepper.hpp"

int main(int argc, char* argv[]) {
    if (argc != 2) {
        std::cerr << "Usage\n"
                  << "    /path/to/IHDG_SWE_OMPI input_file\n";
        return 1;
    } else {
        ...
        IHDG::OMPISimulation<SWE::IHDG::Problem> simulation(input_string);
