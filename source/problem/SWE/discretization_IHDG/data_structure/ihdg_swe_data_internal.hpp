...
struct Internal {
    ...
    std::vector<Vector<double, SWE::n_variables>> q_prev_at_gp;
    std::vector<Vector<double, SWE::n_auxiliaries>> aux_prev_at_gp;
    ...
    std::vector<Vector<double, SWE::n_variables>> del_q_DT_at_gp;
