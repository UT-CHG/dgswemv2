...
void DBDataExchanger::SetPostprocEX(const double ze_at_baryctr_in,
    ...
    this->send_postproc_buffer[this->index.bath_at_baryctr] = bath_at_baryctr_in;
}
...
void DBDataExchanger::GetPostprocEX(double& ze_at_baryctr_ex,
                                    double& qx_at_baryctr_ex,
                                    double& qy_at_baryctr_ex,
                                    double& bath_at_baryctr_ex) {
    ...
    bath_at_baryctr_ex = this->receive_postproc_buffer[this->index.bath_at_baryctr];
}
}
}
