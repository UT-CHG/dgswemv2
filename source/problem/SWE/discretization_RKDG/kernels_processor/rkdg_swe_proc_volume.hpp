...
void Problem::volume_kernel(const RKStepper& stepper, ElementType& elt) {
    ...
    if (wd_state.wet) {
        ...
        for (uint gp = 0; gp < elt.data.get_ngp_internal(); ++gp) {
            ...
            internal.Fx_at_gp[gp][SWE::Variables::qx] = internal.aux_at_gp[gp][SWE::Auxiliaries::sp] * (uuh + pe);
            internal.Fx_at_gp[gp][SWE::Variables::qy] = internal.aux_at_gp[gp][SWE::Auxiliaries::sp] * uvh;
