...
class DBDataExchanger {
  ...
  public:
    ...
    void SetEX(const HybMatrix<double, SWE::n_variables>& q_in);
    ...
    void GetEX(HybMatrix<double, SWE::n_variables>& q_ex);
...
void DBDataExchanger::GetEX(HybMatrix<double, SWE::n_variables>& q_ex) {
