...
void SlopeLimit::serialize(Archive& ar, unsigned) {
    ar& surface_normal& baryctr_coord& midpts_coord& baryctr_coord_neigh& alpha_1& alpha_2& r_sq& ze_at_baryctr&
        qx_at_baryctr& qy_at_baryctr& bath_at_baryctr& ze_at_vrtx& qx_at_vrtx& qy_at_vrtx& ze_at_midpts& qx_at_midpts&
            qy_at_midpts& bath_at_midpts& ze_at_baryctr_neigh& qx_at_baryctr_neigh& qy_at_baryctr_neigh&
                bath_at_baryctr_neigh& w_midpt_char& w_baryctr_char& delta_char& delta& L& R;
}
#endif
}
}
