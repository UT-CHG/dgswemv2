...
namespace SWE {
	...
	public:
			...
			double& ze_ex, double& qx_ex, double& qy_ex)
		{
			...
			if (stepper.get_t_at_curr_stage() < 172800.0) H_0 = H_0 *  stepper.get_t_at_curr_stage() / 172800.0; //LINEAR RAMPING
			double H_ocean = H_0*cos(2 * PI *  stepper.get_t_at_curr_stage() / 43200.0); //FOR TESTING M2 TIDAL WAVE WITH PERIOD OF 12HOURS
